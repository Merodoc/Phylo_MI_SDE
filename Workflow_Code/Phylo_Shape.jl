...
dir = "C:/Users/Rowan/OneDrive/Documents/GitHub/REG_PhD/Workflow_Code/Phy_Bridge_Results/MI_1lPMMnoPVR_121124/"
...
# I should collect all STDevs by node so i can see the spread across all variables between different samples
std_dict["Node 69"]
mean_dict["Node 69"]
...
savefig("2lonlyFemur_TreeMeansbyvar2")
...
#From here figure out what data we want to see