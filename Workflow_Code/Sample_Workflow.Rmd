...
library("plyr")
library("dplyr")
MEANS <- ddply(imp3.dat, .(Species), summarize, mean=mean(dentary))
...
write.csv(MEANS, "Imp_Mars_PVR25new5.csv", row.names=FALSE)
...
Filename = "MarsMIDentaryArticularWidth.csv"
...
Filename = "MarsMIDentaryArticularLength.csv"
write.csv(Output, Filename, row.names = FALSE)
...
Filename = "MarsMIDentaryForamenLength.csv"
write.csv(Output, Filename, row.names = FALSE)
...
Filename = "MarsMIDentaryRowWidthatm4.csv"
write.csv(Output, Filename, row.names = FALSE)
...
Filename = "MarsMIDentaryHeightatm4.csv"
write.csv(Output, Filename, row.names = FALSE)
...
Filename = "MarsMIDentaryHeightatp3.csv"
write.csv(Output, Filename, row.names = FALSE)
...
Filename = "MarsMIscapulainfraspinouswidth.csv"
write.csv(Output, Filename, row.names = FALSE)
...
Filename = "MarsMIscapulainfraspinousLength.csv"
write.csv(Output, Filename, row.names = FALSE)
...
Filename = "MarsMIScapulaGlenoidArticularFacetLength.csv"
write.csv(Output, Filename, row.names = FALSE)
...
Filename = "MarsMIScapulaGlenoidMaxLength.csv"
write.csv(Output, Filename, row.names = FALSE)
...
Filename = "MarsMIScapulaGlenoidWidth.csv"
write.csv(Output, Filename, row.names = FALSE)
...
Filename = "MarsMIScapulaAngleScapulaNeck.csv"
write.csv(Output, Filename, row.names = FALSE)
...
Filename = "MarsMIScapulaAgnelCaudalBorder.csv"
write.csv(Output, Filename, row.names = FALSE)
...
Filename = "MarsMIScapulaHumerusHeadLength.csv"
write.csv(Output, Filename, row.names = FALSE)


###Got up to Humerus in File writing - Do Rest Tomorrow
```